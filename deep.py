...
if __name__ == '__main__':
    start_date = datetime(2014, 8, 11, 1, 0, 0)  # 2025-07-01 07:00:00 2025-08-22 17:44:59
    end_date = datetime(2014, 8, 28, 23, 59, 0)  # 2025-07-01 12:00:00
    interval = 60
    day = 18
    ticker = 'GAZP'
    filename = f'BD/{ticker}_{interval}.csv'
